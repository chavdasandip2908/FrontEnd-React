            ...
            <div className="address-components">
                ...
                <div className="field-group">
                    ...
                    <div className="fiels">
                        ...
                        <select name="country" id="country" value={Props.country} onChange={(e) => Props.func.setCountry(e.target.value)} >
                            <option value="null">Please Select</option>
                            <option value="office">office</option>
                            <option value="home">Home</option>
                        </select>
                ...
                <div className="field-group">
                    <div className="fiels">
                        ...
                        <select name="state" id="state" value={Props.state} onChange={(e) => Props.func.setState(e.target.value)} >
                            <option value="null">Please Select</option>
                            <option value="office">office</option>
                            <option value="home">Home</option>
                        </select>
                    ...
                    <div className="fiels">
                        ...
                        <select name="city" id="city" value={Props.city} onChange={(e) => Props.func.setCity(e.target.value)} >
                            <option value="null">Please Select</option>
                            <option value="office">office</option>
                            <option value="home">Home</option>
                        </select>
